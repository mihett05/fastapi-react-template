...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column(
        "contracts", sa.Column("chat_id", sa.INTEGER(), autoincrement=False, nullable=False)
    )
    op.create_foreign_key("fk_contracts_chat_id_chats", "contracts", "chats", ["chat_id"], ["id"])
    op.drop_constraint(op.f("fk_chats_contract_id_contracts"), "chats", type_="foreignkey")
    # ### end Alembic commands ###
